...
def mc_trial(board, player):
    """
    IMPLEMENTATION OF mc_trial FUNCTION
...
def mc_update_scores(scores, board, player):
    """
    IMPLEMENTATION OF mc_update_scores FUNCTION
...
def get_best_move(board, scores):
    """
    IMPLEMENTATION OF get_best_move FUNCTION
...
def mc_move(board, player, trials):
    """
    IMPLEMENTATION OF mc_move FUNCTION
    ...
    for dummy_i in range(trials):
        ...
        mc_update_scores(scored_board, trial_board, player)

    row, col = get_best_move(board, scored_board)
